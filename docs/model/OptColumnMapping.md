...
|---|---|----|----------|
identifier|<code>str</code>|**required**<br/>pattern: <code>^global|ms_run\[\d+\]|assay\[\d+\]|study_variable\[\d+\]</code><br/>Validation type: **<code>error</code>**|The fully qualified column name\.
