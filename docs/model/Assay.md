...
ms_run_ref|List of <code>int</code>|**required**<br/>min: 1<br/>format: <code>non-negative-integer</code><br/>Validation type: **<code>error</code>**|The ms run\(s\) referenced by this assay\.
